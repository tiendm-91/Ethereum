...
module.exports = async function(callback) {
    try {
        ...
        const token1Amount = web3.utils.toWei("1000", "ether");
        ...
        // Chấp thuận DEX sử dụng MyToken1
        await myToken1.approve(dex.address, token1Amount, { from: account0 });

        // Gửi lệnh swap MyToken1 -> MyToken2
        await dex.token1ToToken2Swap(token1Amount, { from: account0 });
